...
class Xi < Formula
  ...
  on_macos do
    on_arm do
      url "https://github.com/code-by-sia/xi/releases/download/v0.2.0/xi-v0.2.0-macos-arm64.tar.gz"
      sha256 "d6659866230a1733cb96bb0e9a72bafe3de8783ac05d807c51ecff7c86c87b23"
    end
    on_intel do
      url "https://github.com/code-by-sia/xi/releases/download/v0.2.0/xi-v0.2.0-macos-x86_64.tar.gz"
  ...
  on_linux do
    on_arm do
      url "https://github.com/code-by-sia/xi/releases/download/v0.2.0/xi-v0.2.0-linux-arm64.tar.gz"
      sha256 "aae123fcce7e347fb575ea25d5070fb129d5dce9a33555e7168c8d574703295d"
    end
    on_intel do
      url "https://github.com/code-by-sia/xi/releases/download/v0.2.0/xi-v0.2.0-linux-x86_64.tar.gz"
